...
date: 2024-10-19
aiSummary: >
  Nikica explains why understanding the real use case is crucial in software development. He shares stories showing that choosing tech based on trends—rather than actual needs—leads to problems, and emphasizes that the best solutions fit your team, requirements, and long-term goals.
---

Picture this: You're sitting in a meeting room, and someone proudly declares, "We should use GraphQL because Netflix uses it!" _Cue the awkward silence._
...
_Written by a developer who learned these lessons the hard way... multiple times... and will probably learn them again._
